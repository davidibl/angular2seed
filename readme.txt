Ein minimales Angular2 Projektsetup mit package.json und gulp build.
Das Setup mit einem Service und einer Komponente stellt ein kleines Tutorial zum Start dar.
